...
- It's old because the original design dates back to the 1980's.
    ...
    - Most R-Core members are at or nearing retirement.
...
- package for fitting fitting LMMs (linear mixed-effects models), GLMMs (generalized linear mixed models) and NLMMs
...
- To compare means we can simple compare this sum to the sums of all possible subsets of size 10.
